# flask_app/routes/book_routes.py
...
def list_books_for_humans():
    ...
    return render_template("books.html", message="Available books", books=book_records)
...
def create_book():
    print("FORM DATA:", dict(request.form)) #>{"book_title":"__". "author_name":"___"}
